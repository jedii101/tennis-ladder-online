  ...
  <div id="page">
    ...
    <g:ifAnyGranted role="ROLE_ADMIN,ROLE_USER">
      <div class="nav">
        ...
        <span class="menuButton"><a class="rules"   href="${createLink(uri: '/rules.html')}">Rules</a></span>
        <span class="menuButton"><a class="help"   href="${createLink(uri: '/help.html')}">Help</a></span>
