...
<html>
  ...
  <g:set var="entityName" value="${message(code: 'matchSchedule.label', default: 'Challenge Report')}" />
    ...
    <g:form action="saveChallenge" method="post" >
      ...
      <div class="dialog">
        ...
        <table>
          ...
          <g:select name="challenger.id" from="${ladder.Team.list()}" optionKey="id" value="${matchScheduleInstance?.challenger?.id}" disabled="true" />
          </td>
          </tr>
